...
namespace WebCore.Miniblink
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void wkeOnNetGetFaviconCallback(IntPtr webView, IntPtr param, IntPtr url, IntPtr buf);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool wkeAlertBoxCallback(IntPtr webView, IntPtr param, IntPtr msg);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool wkeDownload2Callback(IntPtr webView, IntPtr param, uint expectedContentLength, string url, string mime, string disposition, IntPtr job, IntPtr dataBind);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    public delegate void wkeConsoleCallback(IntPtr webView, IntPtr param, wkeConsoleLevel level,
        IntPtr message, IntPtr sourceName, uint sourceLine, IntPtr stackTrace);
    ...
    // cexer JS对象、函数绑定支持
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate Int64 jsGetPropertyCallback(IntPtr es, Int64 obj, string propertyName);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool jsSetPropertyCallback(IntPtr es, Int64 obj, string propertyName, Int64 value);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate Int64 jsCallAsFunctionCallback(IntPtr es, Int64 obj, IntPtr args, int argCount);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    ...
    public class MBApi
    {
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeSetDebugConfig", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetDebugConfig(IntPtr webView, string debugString, IntPtr param);

        [DllImport(@"node.dll", EntryPoint = "wkeGetDebugConfig", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeRunMessageLoop", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeRunMessageLoop();

        [DllImport(@"node.dll", EntryPoint = "wkeCreateWebWindow", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeCreateWebWindow(_wkeWindowType type, IntPtr parent, int x, int y, int width, int height);

        [DllImport(@"node.dll", EntryPoint = "wkeGetWebView", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetWebView(string name);

        [DllImport(@"node.dll", EntryPoint = "wkeShowWindow", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeShowWindow(IntPtr webView, bool showFlag);

        [DllImport(@"node.dll", EntryPoint = "wkeEnableWindow", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEnableWindow(IntPtr webView, bool enableFlag);
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeDestroyWebWindow", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeSetLanguage", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetLanguage(IntPtr WebView, string language);

        [DllImport(@"node.dll", EntryPoint = "wkeSetViewNetInterface", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeSetName", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeSetUserAgent", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetUserAgent(IntPtr webView, IntPtr userAgent);
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeMoveWindow", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeMoveWindow(IntPtr webView, int x, int y, int width, int height);
        ...
        public static extern void wkeSetMouseEnabled(IntPtr webView, bool b);
        ...
        public static extern bool wkeFireWindowsMessage(IntPtr webView, IntPtr hWnd, uint message, IntPtr wParam, IntPtr lParam, IntPtr result);
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeGetString", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetString(IntPtr wkeString);

        [DllImport(@"node.dll", EntryPoint = "wkeSetWkeDllPath", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetWkeDllPath(string path);
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeSetUserKeyValue", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetUserKeyValue(IntPtr webView, string key, IntPtr value);

        [DllImport(@"node.dll", EntryPoint = "wkeGetUserKeyValue", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeOnConsole", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeNetSetMIMEType", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "wkeNetSetURL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeNetSetURL(IntPtr job, string url);

        [DllImport(@"node.dll", EntryPoint = "wkeNetSetData", CallingConvention = CallingConvention.Cdecl)]
        ...
        public static extern string wkeNetGetMIMEType(IntPtr job);
        ...
        //////////////////////////////////////脚本
        [DllImport(@"node.dll", EntryPoint = "wkeJsBindFunction", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeJsBindFunction(string name, wkeJsNativeFunction fn, IntPtr param, uint argCount);

        [DllImport(@"node.dll", EntryPoint = "wkeJsBindGetter", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeJsBindGetter(string name, wkeJsNativeFunction fn, IntPtr param);

        [DllImport(@"node.dll", EntryPoint = "wkeJsBindSetter", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "jsString", CallingConvention = CallingConvention.Cdecl)]
        public static extern long jsString(IntPtr es,IntPtr strPtr);

        [DllImport(@"node.dll", EntryPoint = "jsToString", CallingConvention = CallingConvention.Cdecl)]
        public static extern string jsToString(IntPtr es, Int64 v);
        ...
        public static extern Int64 jsBoolean(bool b);
        ...
        [DllImport(@"node.dll", EntryPoint = "jsArrayBuffer", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "jsGet", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsGet(IntPtr es, Int64 jsValue, string prop);

        [DllImport(@"node.dll", EntryPoint = "jsSet", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "jsGetGlobal", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsGetGlobal(IntPtr es, string prop);

        [DllImport(@"node.dll", EntryPoint = "jsSetGlobal", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "jsDeleteObjectProp", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"node.dll", EntryPoint = "jsAddRef", CallingConvention = CallingConvention.Cdecl)]
        public static extern void jsAddRef(IntPtr es, long jsValue);

        [DllImport(@"node.dll", EntryPoint = "jsReleaseRef", CallingConvention = CallingConvention.Cdecl)]
        public static extern void jsReleaseRef(IntPtr es, long jsValue);

        [DllImport(@"node.dll", EntryPoint = "wkeNetGetFavicon", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeNetGetFavicon(IntPtr webView, wkeOnNetGetFaviconCallback callback, IntPtr param);
